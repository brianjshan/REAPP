...
export default function Hero() {
  ...
  const rating =
    "⭐".repeat(testimonial.rating) + spaces + "Highly recommended";
      ...
      {fetched ? (
        <>
          ...
          <a
            ...
            className={styles.testimonials__reviewer}
          >
            {"-" + testimonial.reviewer}
          </a>
          <p className={styles.testimonials__reviewDate}>
            {testimonial.reviewDate}
          </p>
        </>
      ) : null}
      <div>
        <div className={styles.testimonials__bottom_quotes}>”</div>
      </div>
    </div>
  );
}
